...
class TestLayer:
    ...
    def test_act_run_through_layer(self): ...
    def test_act_after_serialization_const(self): ...
    def test_act_after_serialization_random(self): ...

    # TODO: tests for fc+act pipeline
    def test_fcact_run_through_layer(self): ...
    def test_fcact_after_serialization_const(self): ...
    def test_fcact_after_serialization_random(self): ...
